...
jQuery('.confirm-delete').confirm({
	text: "Are you sure you want to delete? It is removed from the database and cannot be recovered.",
	title: "Confirmation Required",
	confirmButton: "Sure",
	cancelButton: "No way"
});

jQuery(".confirm-restore").confirm({
    text: "Are you sure you want to reset your product page layout?",
    title: "Confirmation required",
    confirmButton: "Yes I am",
    cancelButton: "No"
});
