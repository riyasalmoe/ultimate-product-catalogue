...
function Add_UPCP_Category($Category_Name, $Category_Description = "") {
		...
		$update = "Category has been successfully created.";
		return $update;
}
...
function Delete_UPCP_Category($Cat) {
		...
		$update = "Category has been successfully deleted.";
		return $update;
}
...
function Add_UPCP_SubCategory($SubCategory_Name, $Category_ID, $SubCategory_Description) {
		...
		$update = "Sub-Category has been successfully created.";
		return $update;
}
...
function Edit_UPCP_SubCategory($SubCategory_ID, $SubCategory_Name, $Category_ID, $SubCategory_Description) {
		...
		$update = "Sub-Category has been successfully edited.";
		return $update;
}
...
function Delete_UPCP_SubCategory($Sub_ID) {
		...
		$update = "Sub-Category has been successfully deleted.";
		return $update;
}
...
function Add_UPCP_Tag($Tag_Name, $Tag_Description) {
		...
		$update = "Tag has been successfully created.";
		return $update;
}
...
function Edit_UPCP_Tag($Tag_ID, $Tag_Name, $Tag_Description) {
		...
		$update = "Tag has been successfully edited.";
		return $update;
}
...
function Delete_UPCP_Tag($Tag_ID) {
		...
		$update = "Tag has been successfully deleted.";
		return $update;
}
...
function Delete_Products_Tags() {
		...
		$update = "Tag has been successfully deleted from product.";
		return $update;
}
...
function Add_UPCP_Catalogue($Catalogue_Name, $Catalogue_Description) {
		...
		$update = "Catalogue has been successfully created.";
		return $update;
}
...
function Edit_UPCP_Catalogue($Catalogue_ID, $Catalogue_Name, $Catalogue_Description, $Catalogue_Layout_Format = "", $Catalogue_Custom_CSS = "") {
		...
		$update = "Catalogue has been successfully edited.";
		return $update;
}
...
function Add_Products_Catalogue() {
		...
		$update = "Products have been successfully added to the catalogue.";
		return $update;
}
...
function Add_Categories_Catalogue() {
		...
		$update = "Categories have been successfully added to the catalogue.";
		return $update;
}
...
function Delete_UPCP_Catalogue($Catalogue_ID) {
		...
		$update = "Catalogue has been successfully deleted.";
		return $update;
}
...
function Delete_Products_Catalogue() {
		...
		$update = "Product has been successfully deleted from catalogue.";
		return $update;
}

/* Adds a single new product inputted via the form on the left-hand side of the
*  products' page to the UPCP database */
function Add_UPCP_Product($Item_Name, $Item_Photo_URL, $Item_Description, $Item_Price, $Category_ID = "", $Global_Item_ID = "", $Item_Special_Attr = "", $SubCategory_ID = "", $Tags = array()) {
		global $wpdb;
		global $items_table_name;
		global $categories_table_name;
		global $subcategories_table_name;
		...
		$update = "Menu item has been successfully created.";
		return $update;
}

/* Edits a single product in the UPCP database */
function Edit_UPCP_Product($Item_ID, $Item_Name, $Item_Photo_URL, $Item_Description, $Item_Price, $Category_ID = "", $Global_Item_ID = "", $Item_Special_Attr = "", $SubCategory_ID = "", $Tags = array()) {
		global $wpdb;
		global $items_table_name;
		global $categories_table_name;
		global $subcategories_table_name;	
		...
		$update = "Menu item has been successfully edited.";
		return $update;
}
    ...
    $objReader = PHPExcel_IOFactory::createReader($inputFileType);
		...
		foreach ($Titles as $Title) {
				if (!array_key_exists($Title, $Allowed_Fields)) {
					  $Error = "You have a column which is not recognized: " . $Title . ". <br>Please make sure that the column names match the product field labels exactly.";
						return $Error;
				}
		}
...
function Delete_UPCP_Product($Item_ID) {
		...
		$update = "Product has been successfully deleted.";
		return $update;
}
...
function Add_Product_Image($Item_ID, $Image_URL, $Image_Description = "") {
		...
		$update = "Image has been successfully added to the product.";
		return $update;
}
...
function Delete_Product_Image() {
		...
		$update = "Image has been successfully removed.";
		return $update;
}
?>