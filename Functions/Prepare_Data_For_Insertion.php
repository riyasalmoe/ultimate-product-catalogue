...
function Mass_Delete_Products() {
		...
		$update = "Products have been successfully deleted.";
...
function Mass_Delete_Categories() {
		...
		$update = "Categories have been successfully deleted.";
		$user_update = array("Message_Type" => "Update", "Message" => $update);
		return $user_update;
}
...
function Mass_Delete_SubCategories() {
		...
		$update = "Sub-Categories have been successfully deleted.";
		$user_update = array("Message_Type" => "Update", "Message" => $update);
		return $user_update;
}
...
function Mass_Delete_UPCP_Tags() {
		...
		$update = "Tag(s) have been successfully deleted.";
		$user_update = array("Message_Type" => "Update", "Message" => $update);
		return $user_update;
}
...
function Mass_Delete_Catalogues() {
		...
		$update = "Catalogues have been successfully deleted.";
		$user_update = array("Message_Type" => "Update", "Message" => $update);
		return $user_update;
}
?>
