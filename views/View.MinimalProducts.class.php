...
class ewdupcpViewMinimalProducts extends ewdupcpView {
	...
	public function set_items() {
		...
		if ( ! empty( $this->product_ids ) ) {
			...
			$product_ids = array_intersect( $product_ids, explode( ',', $this->product_ids ) );
		}

		if ( ! empty( $this->category_id ) ) {

			$category_ids = array_intersect( $category_ids, explode( ',', $this->category_id ) );
		}

		if ( ! empty( $this->subcategory_id ) ) {

			$category_ids = array_intersect( $category_ids, explode( ',', $this->subcategory_id ) );
		}
