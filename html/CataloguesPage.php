...
<div class="form-field form-required">
	...
	<p>The name of the catalogue. This is for your own internal use, and to insert the catalogue into a page or post.</p>
</div>
<div class="form-field">
	<label for="Catalogue_Description">Description</label>
	<textarea name="Catalogue_Description" id="Catalogue_Description" rows="5" cols="40"></textarea>
	<p>The description of the catalogue. What will it be used to display?</p>
</div>

<p class="submit"><input type="submit" name="submit" id="submit" class="button-primary" value="Add New Catalogue"  /></p></form></div>
<br class="clear" />
</div>
</div>
