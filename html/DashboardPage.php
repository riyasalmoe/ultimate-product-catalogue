							...
							<div id="upcp_pro" class="postbox " >
									...
									<h3 class='hndle'><span><?php _e("Thank You!", 'UPCP') ?></span></h3>
							 		<div class="inside">
											...
											<?php } else { ?><ul><li><?php _e("Thanks for upgrading to version 2.4.16!", "UPCP"); ?><br> <a href='https://www.youtube.com/channel/UCZPuaoetCJB1vZOmpnMxJNw'><?php _e("Subscribe to our YouTube channel ", "UPCP"); ?></a> <?php _e("for tutorial videos on this and our other plugins!", "UPCP");?> </li></ul><?php } ?>
