					...
					<div id="side-sortables" class="metabox-holder ">
							...
							<div class="handlediv" title="Click to toggle"></div><h3 class='hndle'><span><?php _e("Thank You!", 'UPCP') ?></span></h3>
							 		<div class="inside">
											...
											<?php } else { ?><ul><li><?php _e("Thanks for upgrading to version 2.1.5!", "UPCP"); ?><br> <a href='http://www.facebook.com/EtoileWebDesign'><?php _e("Follow us on Facebook", "UPCP"); ?></a> <?php _e("to suggest new features or hear about upcoming ones!", "UPCP");?> </li></ul><?php } ?>
									</div>
							</div>
							</div>
					</div>
